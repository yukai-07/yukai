...
export default class Home extends Component {
    ...
    return (
        <div>
            ...
            <Grid itemStyle={{margin:'0 0 20px 0',height:'80px'}} data={this.state.data} isCarousel columnNum={5} hasLine={false} />
            ...
            <Flex>
                ...
                <Flex.Item>
                    ...
                    <img className="active-img" src={require("./../asset/img/activity2.jpg")}></img>
                </Flex.Item>
                <Flex.Item>
                    <h3 className="active-title active-title-red">工作简餐</h3>
                    <p className="active-text">实惠方便选择多</p>
                    <img className="active-img" src={require("./../asset/img/activity3.png")}></img>
                </Flex.Item>
            </Flex>
            <WhiteSpace size="lg"></WhiteSpace>
